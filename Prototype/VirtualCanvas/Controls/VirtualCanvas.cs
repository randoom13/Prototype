...
using Prototype.Main.VirtualCanvas.Controls;
            ...
            try
            {
                ...
                foreach (Visual visual in this.VisualChildren)
                {
                    ...
                    if (child != null)
                    {
                        ...
                        ISpatialItem? spatial = ItemFromVisual(child);
                        if (spatial != null && this.ComputeOutlineGeometry)
                        {
                            spatial.OnMeasure(child);
                           // finalSize = new Size(finalSize.Width+res.Width, finalSize.Height+res.Height);
                        }
                    }
                }
                if (Measured != null)
            ...
            using (this.BeginUpdate())
            {
                try
                {
                    ...
                    foreach (Visual visual in this.VisualChildren)
                    {
                        ...
                        ISpatialItem? spatialItem = ItemFromVisual(child);
                        if (spatialItem == null)
                        {
                            continue;
                        }

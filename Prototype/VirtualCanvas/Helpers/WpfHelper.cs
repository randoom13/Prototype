...
namespace Prototype.Main.VirtualCanvas.Helpers
{
    internal static class WpfHelper
    {
        ...
        {
            return target.SetBinding(dp, source, property, BindingMode.Default);
        }
        ...
        {
            return target.SetBinding(dp, source, property, mode, null);
        }
        ...
        {
            return target.SetBinding(dp, source, property, mode, format, null);
        }
        ...
        {
            return target.SetBinding(dp, source, property, mode, format, converter, null);
        }
        ...
        {
            if (!a.Width.IsAlmostEqual(b.Width, tolerance))
            {
                return false;
            }
            if (!a.Height.IsAlmostEqual(b.Height, tolerance))
            {
                return false;
            }
            return true;
        ...
        {
            if (!a.X.IsAlmostEqual(b.X, tolerance))
            {
                return false;
            }
            if (!a.Y.IsAlmostEqual(b.Y, tolerance))
            {
                return false;
            }
            return true;
        ...
        {
            if (!a.TopLeft.IsAlmostEqual(b.TopLeft, tolerance))
            {
                return false;
            }
            if (!a.BottomRight.IsAlmostEqual(b.BottomRight, tolerance))
            {
                return false;
            }
            return true;
        ...
        {
            if (!a.Left.IsAlmostEqual(b.Left, tolerance))
            {
                return false;
            }
            if (!a.Right.IsAlmostEqual(b.Right, tolerance))
            {
                return false;
            }
            if (!a.Top.IsAlmostEqual(b.Top, tolerance))
            {
                return false;
            }
            if (!a.Bottom.IsAlmostEqual(b.Bottom, tolerance))
            {
                return false;
            }
            return true;
